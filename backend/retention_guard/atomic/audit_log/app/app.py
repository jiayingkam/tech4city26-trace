...
def create_app() -> Flask:
    ...
    from .routes import audit_log_bp
    ...
    def _json_unhandled_error(error):
        if isinstance(error, HTTPException):
            return error
        app.logger.exception("Unhandled audit_log service error", exc_info=error)
